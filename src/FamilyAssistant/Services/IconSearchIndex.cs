...
public static partial class IconSearchIndex
{
    ...
    private static Dictionary<string, List<string>> BuildGermanIndex()
    {
        ...
        var mappings = new Dictionary<string, string[]>
        {
            ...
            ["saugen"] = ["Vacuum", "RobotVacuum", "CleaningServices"],
            ["staubsaugen"] = ["Vacuum", "RobotVacuum", "CleaningServices"],
            ["staubsauger"] = ["Vacuum", "RobotVacuum"],
            ["saugroboter"] = ["RobotVacuum", "Vacuum"],
            ["wischen"] = ["CleaningServices"],
            ["fegen"] = ["Broom", "CleaningServices"],
            ["kehren"] = ["Broom", "CleaningServices"],
            ["besen"] = ["Broom"],
            ["staub"] = ["CleaningServices", "Air", "SprayBottle"],
            ["aufräumen"] = ["CleaningServices", "Inventory2", "Shelves"],
            ["ordnung"] = ["Inventory2", "Shelves", "Sort"],
            ["sortieren"] = ["Sort", "Inventory2"],
            ["waschen"] = ["LocalLaundryService", "WashingMachine", "WashOutlined", "Soap"],
            ["wäsche"] = ["LocalLaundryService", "WashingMachine", "TumbleDryer", "DryCleaningOutlet", "Checkroom"],
            ["waschmaschine"] = ["WashingMachine", "LocalLaundryService"],
            ["trockner"] = ["TumbleDryer", "LocalLaundryService", "DryCleaningOutlet"],
            ["bügeln"] = ["Iron"],
            ...
            ["dusche"] = ["Shower"],
            ["toilette"] = ["Toilet", "Bathroom", "Wc"],
            ["klo"] = ["Toilet", "Bathroom", "Wc"],
            ...
            ["geschirr"] = ["Kitchen", "Dishwasher", "LocalDining", "DinnerDining"],
            ["spülen"] = ["Kitchen", "Dishwasher", "WaterDrop", "LocalDining"],
            ["geschirrspüler"] = ["Dishwasher", "Kitchen", "DinnerDining"],
            ["spülmaschine"] = ["Dishwasher", "Kitchen", "DinnerDining"],
