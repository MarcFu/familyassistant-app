...
public class HomeAssistantSyncService : BackgroundService
{
    ...
    /// Creates entities like sensor.hasscompanion_emilian_credits
    /// </summary>
    private async Task SyncCreditsToHaAsync(CancellationToken ct)
    {
        ...
        {
            var entityId = $"sensor.hasscompanion_{SanitizeName(person.Name)}_credits";
